...
var Content = /*#__PURE__*/function () {
  ...
  _createClass(Content, [{
    ...
    value: function render(data, updateList) {
      ...
      var template = "\n      <h3><u>".concat(this.data.title, "</u></h3>\n      <h6>").concat(this.data.date, "</h6>\n      <div class= \"dataContentDiv pt-2\" >").concat(this.data.html, "</div>\n    ");
...
var Form = /*#__PURE__*/function () {
  ...
  _createClass(Form, [{
    ...
    value: function _parseStringToHtml(content) {
      var resultContent = content.replace(/(#\s)(.+)(\n|$)/gim, "<h1>$2</h1>$3").replace(/(#{2}\s)(.+)(\n|$)/gim, "<h2>$2</h2>$3").replace(/(#{3}\s)(.+)(\n|$)/gim, "<h3>$2</h3>$3").replace(/(#{4}\s)(.+)(\n|$)/gim, "<h4>$2</h4>$3").replace(/(\*{2})(.+)(\*{2})/gim, "<strong>$2</strong>").replace(/(~{2})(.+)(~{2})/gim, "<strike>$2</strike>").replace(/(https?:\/\/)(.+)(\s{1}|\.|,|!|\?|$)/gim, "<a href=\"$1$2\" target=\"_blank\" rel=\"noopener\">$1$2</a>$3").replace(/-{3}/gim, "<hr>").replace(/-\|/gim, "<br>").replace(/(\+{2})(.+)(\+{2})(\n|$)/gim, "<span class=\"text-success\">$2</span>$4").replace(/(\-{2})(.+)(\-{2})(\n|$)/gim, "<span class=\"text-danger\">$2</span>$4").replace(/\*(.+)/gim, "<ul>\n          <li>$1</li>\n        </ul>");
